...
public class ElementsTestService {

    private ElementsTestMapper mapper;

    public void selectCacheTest(){
        SqlSession sqlSession = getSqlSession();
        mapper = sqlSession.getMapper(ElementsTestMapper.class);
    ...
    public void insertNewMenu(MenuAndCategory menu){
        ...
        mapper = session.getMapper(ElementsTestMapper.class);
